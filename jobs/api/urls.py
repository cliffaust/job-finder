...
urlpatterns = [
    path('companies/<company_slug>/jobs/', JobListView.as_view(), name="company-jobs"),
    path('jobs/', JobListView.as_view(), name="jobs"),
    path('companies/<company_slug>/create-job/', JobCreateView.as_view(), name="create-company"),
    ...
    path('jobs/<job_slug>/create-seeker/', SeekerCreateView.as_view(), name="create-seeker"),
